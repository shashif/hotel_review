...
class _FreePostScreenState extends State<FreePostScreen> {
  ...
  Future uploadFile() async {
    ...
    for (var img in _imagePath) {
      ...
      var ref = FirebaseStorage.instance.ref().child('FreePostImage/$fileName');
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      decoration:
                          InputDecoration(hintText: 'Facebook or Website link'),
                      keyboardType: TextInputType.url,
                      controller: freePostProvider.urlController,
                    ),
                    SizedBox(
                      height: 5,
                    ),
                        ...
                        onPressed: () {
                          ...
                          setState(() {
                            freePostProvider.userImageURlController.text =
                                userImage;
                            freePostProvider.userNameController.text = userName;
                            freePostProvider.emailController.text = userEmail;
